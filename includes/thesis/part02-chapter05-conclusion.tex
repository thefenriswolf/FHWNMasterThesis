...
comparing their performance using the \glsxtrlong{hd}.
...
when comparing their results using the \glsxtrlong{hd}.
...
clavicle when comparing their performance using the \glsxtrlong{dc}.
...
when comparing their performance using the \glsxtrlong{hd}.
