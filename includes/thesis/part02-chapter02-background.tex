...
\noindent
Equation 3 shows how \acrshort{hu} are computed.
...
In other words, firstly, there is a horizontal kernel $G_{x}$ (see Equation \ref{eqn:gx}) which is intended to emphasize changes in
...
\end{equation}
\noindent
Secondly, the vertical kernel $G_{y}$ (see Equation \ref{eqn:gy}) is used to highlight changes in intensity in vertical direction:
...
The second derivative can be approximated using the Laplacian operator (see Equation \ref{eqn:laplace}):
